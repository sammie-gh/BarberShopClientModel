    ...
    private void getTimerCount() {
        new CountDownTimer(77000, 1000) {
            ...
            public void onTick(long duration) {
                ...
                if (Ssec < 10) {
                    next.setText("Verifying payment please wait for the countdown " + Mmin + ":0" + Ssec + " remaining");


                } else
                    next.setText("Verifying payment please wait for the countdown " + Mmin + ":" + Ssec + " remaining");
